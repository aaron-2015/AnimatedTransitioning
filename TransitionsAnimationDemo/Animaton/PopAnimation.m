...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext
{
    ...
    UIButton *pushButton = toVC.button;
    UIBezierPath *endPath = [UIBezierPath bezierPathWithOvalInRect:pushButton.frame];
    ...
    UIBezierPath *startpath = [UIBezierPath bezierPathWithOvalInRect:CGRectInset(pushButton.frame, -radius, -radius)]; //-radius表示增大,+radius表示缩小
    ...
    [maskLayer addAnimation:maskLayerAnimation forKey:@"pop"];
}
